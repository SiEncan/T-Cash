...
class _IncomeExpensePageState extends State<IncomeExpensePage> {
  ...
  Future<void> _fetchData() async {
    try {
      ...
      // Panggil fungsi setelah frame selesai dirender
      if (selectedMonth.month == DateTime.now().month) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          const double a = 0.19919261343839537;
          const double b = 60.337131656090804;
          const double c = 6.84875621643199;

          int today = DateTime.now().day;
          double scrollToPosition = a * (today * today) + b * today + c;
                    ...
                    SizedBox(
                        ...
                        child: dailyDates.isNotEmpty
                            ? SingleChildScrollView(
                                ...
                                child: SizedBox(
                                  width: daysInMonth *
                                      80, // Lebar sesuai 30/31 hari (80 piksel per hari)
                                  child: LineChart(
                                    LineChartData(
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            currentView == 'Income' ? Colors.blue : Colors.grey,
